...
import 'package:flutter_stub_ui/ui.dart' show isWeb;
...
abstract class DiagnosticsNode {
  ...
  Map<String, Object> toJsonMap() {
    ...
    if (allowTruncate) data['allowTruncate'] = allowTruncate;
    ...
    if (!allowWrap) data['allowWrap'] = allowWrap;

    if (allowNameWrap) data['allowNameWrap'] = allowNameWrap;
