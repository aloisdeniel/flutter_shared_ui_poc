...
import 'package:flutter_stub_ui/ui.dart' show lerpDouble, hashValues;
...
class StackParentData extends ContainerBoxParentData<RenderBox> {
  ...
  // TODO(flutter_web): upstream debugPrintDouble otherwise tests fail or need
  // to be special cased for web.
  @override
  String toString() {
