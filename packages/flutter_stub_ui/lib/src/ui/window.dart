...
abstract class Window {
  ...
  bool get semanticsEnabled => throw UnsupportedError('');
  ...
  void updateSemantics(SemanticsUpdate update) => throw UnsupportedError('');
  ...
  ///  * [RendererBinding], the Flutter framework class which manages layout and
  ///    painting.
  void render(Scene scene) => throw UnsupportedError('');
...
Window get window => throw UnsupportedError('');
