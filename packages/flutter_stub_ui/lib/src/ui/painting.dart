...
class Paint {
  ...
  set invertColors(bool _) => throw UnsupportedError('');
...
abstract class Gradient extends Shader {
  ...
  factory Gradient.radial(Offset center, double radius, List<Color> colors,
      ...
      Float64List matrix4,
      Offset focal,
      double focalRadius = 0.0]) => throw UnsupportedError('');
...
class _GradientSweep extends Gradient {
  ...
  @override
  Object createPaintStyle(_) => throw UnsupportedError('');
...
class Codec {
  ...
  Future<FrameInfo> getNextFrame() => throw UnsupportedError('');
...
Future<Codec> instantiateImageCodec(Uint8List list,
    {double decodedCacheRatioCap = double.infinity}) => throw UnsupportedError('');


Future<Codec> webOnlyInstantiateImageCodecFromUrl(Uri uri) => throw UnsupportedError('');
...
void decodeImageFromList(Uint8List list, ImageDecoderCallback callback) => throw UnsupportedError('');
...
void decodeImageFromPixels(Uint8List pixels, int width, int height,
    ...
    {int rowBytes}) => throw UnsupportedError('');
