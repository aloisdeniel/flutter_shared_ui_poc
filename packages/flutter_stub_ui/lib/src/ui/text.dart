...
abstract class ParagraphBuilder {
  ...
  /// [Paragraph].
  factory ParagraphBuilder(ParagraphStyle style) => throw UnsupportedError('');
...
Future<void> loadFontFromList(Uint8List list, {String fontFamily}) => throw UnsupportedError('');
